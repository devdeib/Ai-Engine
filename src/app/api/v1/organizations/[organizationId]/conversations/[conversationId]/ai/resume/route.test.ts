...
const BASE_PATH = `/api/v1/organizations/${ORG_A}/conversations/${CONV_1}/ai/resume`;
...
describe("POST /conversations/:id/ai/resume", () => {
  ...
  it("returns 200 and resumes with trusted ids", async () => {
    ...
    expect(resumeAI).toHaveBeenCalledWith(ORG_A, USER_1, CONV_1);
  });
});
