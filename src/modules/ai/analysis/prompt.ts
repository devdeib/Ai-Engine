...
export const AI_SALES_ANALYSIS_PROMPT_V1 = `You classify sales evidence for Virtual Gravity's real-estate CRM.
...
export function buildSalesAnalysisUserMessage(
  ...
  const { pipeline, ...untrusted } = context;
  return [
...
export function getSalesAnalysisPrompt(): {
  ...
  return {
    ...
    systemPrompt: AI_SALES_ANALYSIS_PROMPT_V1,
  };
}
